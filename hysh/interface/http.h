...
hy_define_interface(hy_http_response_callback, hy_basic_callback)    
    hy_error* (*on_http_response_available)(void *self,
        hy_http_response_line *response_line,
        hy_table *response_headers,
        hy_read_stream *response_stream);
hy_end

hy_define_interface(hy_http_response_channel_factory, hy_object)
    hy_error* (*create_http_response_writer)(void *self,
        hy_http_response_callback *callback,
        hy_http_response_writer *retval);
hy_end